...
<xsl:stylesheet version="1.0" 
	...
	xmlns:ns0="urn:grupohcc.com:pi:successfactors:2.0" 
   ...
   <xsl:template match="/*">
      	...
      	<ns2:insert>
               		<xsl:apply-templates select="insert/type"/>
               		<xsl:apply-templates select="insert/sfobject"/>
               		<xsl:apply-templates select="insert/processingParam"/>
         </ns2:insert>
   </xsl:template>
